	...
	var S2 = (function() {
		...
		S2.define('select2/selection/search', ['jquery', '../utils', '../keys'], function($, Utils, KEYS) {
			...
			Search.prototype.render = function(decorated) {
				var $search = $('<li class="select2-search select2-search--inline">' + '<input class="select2-search__field" type="search" tabindex="-1"' + ' autocomplete="off" maxlength="64" autocorrect="off" autocapitalize="off"' + ' spellcheck="false" role="textbox" aria-autocomplete="list" />' + '</li>');
		...
		S2.define('select2/i18n/en', [], function() {
			return {
				...
				inputTooShort: function(args) {
					...
					var message = '请输入 ' + remainingChars + ' 或者更多其他';
					return message
				},
				...
				maximumSelected: function(args) {
					var message = '你最多只能添加 ' + args.maximum + ' 条';
					return message
				},
				noResults: function() {
					return '无此选项'
		...
		S2.define('select2/defaults', ['jquery', 'require', './results', './selection/single', './selection/multiple', './selection/placeholder', './selection/allowClear', './selection/search', './selection/eventRelay', './utils', './translation', './diacritics', './data/select', './data/array', './data/ajax', './data/tags', './data/tokenizer', './data/minimumInputLength', './data/maximumInputLength', './data/maximumSelectionLength', './dropdown', './dropdown/search', './dropdown/hidePlaceholder', './dropdown/infiniteScroll', './dropdown/attachBody', './dropdown/minimumResultsForSearch', './dropdown/selectOnClose', './dropdown/closeOnSelect', './i18n/en'], function($, require, ResultsList, SingleSelection, MultipleSelection, Placeholder, AllowClear, SelectionSearch, EventRelay, Utils, Translation, DIACRITICS, SelectData, ArrayData, AjaxData, Tags, Tokenizer, MinimumInputLength, MaximumInputLength, MaximumSelectionLength, Dropdown, DropdownSearch, HidePlaceholder, InfiniteScroll, AttachBody, MinimumResultsForSearch, SelectOnClose, CloseOnSelect, EnglishTranslation) {
			...
			Defaults.prototype.reset = function() {
				...
				function matcher(params, data) {
					...
					if (stripDiacritics(data.text).toPinYin != undefined) original = stripDiacritics(data.text).toPinYin().indexOf(stripDiacritics(params.term).toUpperCase());
					if (original == -1) {
