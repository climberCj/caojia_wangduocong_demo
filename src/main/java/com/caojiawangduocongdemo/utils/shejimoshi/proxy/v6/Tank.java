package com.caojiawangduocongdemo.utils.shejimoshi.proxy.v6;
...
public class Tank implements Moveable{
    ...
    public static void main(String[] args) throws InterruptedException {
        new RecordLogProxy(new RecordTimeProxy(new Tank())).move();
    }
}
...
class RecordTimeProxy implements Moveable{
    ...
    public RecordTimeProxy(Moveable m){
        this.m = m;
    }
...
class RecordLogProxy implements Moveable{
    ...
    public RecordLogProxy(Moveable m){
        this.m = m;
    }
